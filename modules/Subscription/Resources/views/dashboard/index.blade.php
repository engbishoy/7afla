...
@section('pageHead')
<title>{{ __('subscription::header.title') }} | Sengine</title>
...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
    ...
    <!--begin::Title-->
    <h1 class="d-flex align-items-center fw-bolder fs-3 my-1 toolbar-main-title-color">{{ __('subscription::header.title') }}</h1>
    <!--end::Title-->
</div>
<!--end::Page title-->
@endsection
        ...
        <div class="card">
            ...
            <div id="header-container" class="card-header border-0 pt-6">
                ...
                <x-dashboard::dt-toolbar>
                    ...
                    @can('subscription.actions.add')
                    <!--begin::Add-->
                    <x-dashboard::dt-add-btn dt-target="_datatable" data-action-url="{{ route('subscription.create') }}"/>
                    <!--end::Add-->
                    @endcan

                
                    @can('subscription.actions.export')
                    <!--begin::Export-->
                    ...
                    <x-slot name="group">
                        ...
                        <x-dashboard::dt-actn-grp>
                            @can('subscription.actions.delete')
                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('subscription.destroy.many') }}" />
                            @endcan
                        </x-dashboard::dt-actn-grp>
                        <!--end::Input group-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <x-dashboard::data-table id="_datatable" data-url="{{ route('subscription.datatable') }}" 
                    data-order='[[ 1, "desc" ]]' data-page-length='25'>

                    <th>
                        {{ __('subscription::datatable.columns.service name') }}
                    </th>

                    <th>
                        {{ __('subscription::datatable.columns.duration') }}
                    </th>


                    <th>
                        {{ __('subscription::datatable.columns.price') }}
                    </th>


                    <th>
                        {{ __('subscription::datatable.columns.creation_date') }}
                    </th>
...
<script src="{{asset('/themes/metro8/assets/modules/subscription/js/subscription.js')}}"></script>
