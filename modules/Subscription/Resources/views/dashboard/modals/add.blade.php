...
<form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="post" id="dt_modal_form"
    ...
    <div class="modal-header custom-modal-header" id="kt_modal_add_customer_header">
        ...
        <div class="d-flex flex-shrink-0 p-1">
            <p class="main-modal-title"><span class="svg-icon svg-icon-2 me-2"><i class="far fa-plus-circle fs-2"></span></i><span class="text-uppercase fs-3">{{ __('subscription::modal.add-title') }}</span></p>
        </div>
        <!--end::Modal title-->
            ...
            <div class="group-container mb-5">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="control-label required fs-6 mb-2">{{ __('subscription::modal.form.The number of days')  }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
