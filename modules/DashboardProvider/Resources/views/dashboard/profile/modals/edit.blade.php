            ...
            <div class="group-container mb-5">
                ...
                <div class="col-md-6">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                    <input type="number" class="form-control custom-form-control" placeholder="" name="capacity" value="{{$profile->capacity}}">
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                </div>
                ...
                @foreach ($profile->times as $index=>$timer)
                ...
                <div class="col-md-6">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="date" class="form-control custom-form-control due_date" placeholder="" value="{{$timer->start_time}}" name="start_time[]">
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="date" class="form-control custom-form-control due_date" placeholder="" value="{{$timer->end_time}}"  name="end_time[]">
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                </div>
