        ...
        <div class="card">
            ...
            <div id="header-container" class="card-header border-0 pt-6">
                ...
                <x-dashboard::dt-toolbar>
                    ...
                    <!--begin::Add-->
                    <x-dashboard::dt-add-btn dt-target="_datatable" data-action-url="{{ route('dashboard.provider.profile.create',[$service->id]) }}"/>
                    <!--end::Add-->
                    ...
                    <x-slot name="group">
                        ...
                        <x-dashboard::dt-actn-grp>
                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('dashboard.provider.profile.destroy.many') }}" />
                        </x-dashboard::dt-actn-grp>
                        <!--end::Input group-->
                        <!--begin::Input group-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <x-dashboard::data-table id="_datatable" data-url="{{ route('dashboard.provider.profile.datatable',[$service->id]) }}" 
