        ...
        <div class="card">
            ...
            <div id="header-container" class="card-header border-0 pt-6">
                ...
                <x-dashboard::dt-toolbar>
                    ...
                    <!--begin::Add-->
                    <x-dashboard::dt-add-btn dt-target="_datatable" data-action-url="{{ route('dashboard.provider.package.create') }}"/>
                    <!--end::Add-->
                    ...
                    <x-slot name="group">
                        ...
                        <x-dashboard::dt-actn-grp>
                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('dashboard.provider.package.destroy.many') }}" />
                        </x-dashboard::dt-actn-grp>
                        <!--end::Input group-->
                        <!--begin::Input group-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <x-dashboard::data-table id="_datatable" data-url="{{ route('dashboard.provider.package.datatable') }}" 
                    ...
                    <th>
                        {{ __('package::datatable.columns.details') }}
                    </th>
...
<script src="{{asset('/themes/metro8/assets/modules/DashboardProvider/package/js/package.js')}}"></script>
