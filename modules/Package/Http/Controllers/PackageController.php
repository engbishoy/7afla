...
class PackageController extends AppController
{
    ...
    public function index()
    {
        ...
        return view('package::dashboard.index');
    }
    ...
    public function create()
    {
        $this->setAjaxParams([
            ...
            'dt_modal_submit_url' => route('package.store')
        ]);
        $profiles = Profile::all();
        return view('package::dashboard.modals.add', compact('profiles'));
    }
    ...
    public function edit(Package $package)
    {
        $this->setAjaxParams([
            ...
            'dt_modal_submit_url' => route('package.update', [$package->id]),
        ]);
        $profiles = Profile::all();
        return view('package::dashboard.modals.edit', compact('package', 'profiles'));
    }
