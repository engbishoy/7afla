...
<form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="post" id="dt_modal_form"
    ...
    <div class="modal-header custom-modal-header" id="kt_modal_add_customer_header">
        ...
        <div class="d-flex flex-shrink-0 p-1">
            <p class="main-modal-title"><span class="svg-icon svg-icon-2 me-2"><i class="far fa-plus-circle fs-2"></span></i><span class="text-uppercase fs-3">{{ __('provider::modal.gallary.add-gallary') }}</span></p>
        </div>
        <!--end::Modal title-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="control-label required fs-6 mb-2">{{ __('provider::modal.form.gallary.photos') }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <div class="dropzone dropzone-default dropzone-primary" id="kt_dropzone_2">
                                <div class="dropzone-msg dz-message needsclick">
                                    <h3 class="dropzone-msg-title">{{ __('provider::modal.form.gallary.drop photos here') }}</h3>
                                </div>
                            </div>
                            <!--end::Input-->
                        </div>
