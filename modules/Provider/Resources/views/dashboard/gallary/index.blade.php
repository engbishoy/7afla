...
@section('pageHead')
<title>{{ __('provider::header.gallary') }} | Sengine</title>
...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
    ...
    <!--begin::Title-->
    <h1 class="d-flex align-items-center fw-bolder fs-3 my-1 toolbar-main-title-color">{{ __('provider::header.gallary').' ' . $provider->name }}</h1>
    <!--end::Title-->
</div>
<!--end::Page title-->
@endsection
        ...
        <div class="card">
            ...
            <div id="header-container" class="card-header border-0 pt-6">
                ...
                <x-dashboard::dt-toolbar>
                    ...
                    <!--begin::Add-->
                    <x-dashboard::dt-add-btn dt-target="_datatable" data-action-url="{{ route('provider.gallary.create',['provider'=>$provider->id]) }}"/>
                    <!--end::Add-->
                    ...
                    <x-slot name="group">
                        ...
                        <x-dashboard::dt-actn-grp>
                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('provider.gallary.destroy.many') }}" />
                        </x-dashboard::dt-actn-grp>
                        <!--end::Input group-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <x-dashboard::data-table id="_datatable" data-url="{{ route('provider.gallary.datatable',['provider'=>$provider->id]) }}" 
                    data-order='[[ 1, "desc" ]]' data-page-length='25'>

                    <th>
                        {{ __('provider::datatable.columns.gallary.photo') }}
                    </th>
...
<script src="{{asset('/themes/metro8/assets/modules/provider/js/gallary.js')}}"></script>
