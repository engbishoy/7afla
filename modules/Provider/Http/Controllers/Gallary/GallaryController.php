...
class GallaryController extends AppController
{
   /**
    ...
    public function index(Provider $provider)
    {
        ...
        return view('provider::dashboard.gallary.index',compact('provider'));
    }
    ...
    public function create(Provider $provider)
    {
        $this->setAjaxParams([
            ...
            'dt_modal_submit_url' => route('provider.gallary.store',$provider->id)
        ]);
       
        return view('provider::dashboard.gallary.modals.add');
    }
