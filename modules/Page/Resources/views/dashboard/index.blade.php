...
@section('pageHead')
<title>{{ __('page::header.title') }} | Sengine</title>
...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
    ...
    <!--begin::Title-->
    <h1 class="d-flex align-items-center fw-bolder fs-3 my-1 toolbar-main-title-color">{{ __('page::header.title') }}</h1>
    <!--end::Title-->
</div>
<!--end::Page title-->
@endsection
        ...
        <div class="card">
            ...
            <div id="header-container" class="card-header border-0 pt-6">
                ...
                <x-dashboard::dt-toolbar>
                    ...
                    <!--begin::Add-->
                    <x-dashboard::dt-add-btn dt-target="_datatable" data-action-url="{{ route('page.create') }}"/>
                    <!--end::Add-->
                    ...
                    <x-slot name="group">
                        ...
                        <x-dashboard::dt-actn-grp>
                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('page.destroy.many') }}" />
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <x-dashboard::data-table id="_datatable" data-url="{{ route('page.datatable') }}" 
                    data-order='[[ 1, "desc" ]]' data-page-length='25'>

                    <th>
                        {{ __('page::datatable.columns.title') }}
                    </th>

                    <th>
                        {{ __('page::datatable.columns.content') }}
                    </th>
       
                    <th>
                        {{ __('page::datatable.columns.creation_date') }}
                    </th>
...
<script src="{{asset('/themes/metro8/assets/modules/page/js/page.js')}}"></script>
