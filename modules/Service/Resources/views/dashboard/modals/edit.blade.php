...
<form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="post" id="dt_modal_form"
    ...
    <div class="modal-header custom-modal-header" id="kt_modal_add_customer_header">
        ...
        <div class="d-flex flex-shrink-0 p-1">
            <p class="main-modal-title"><span class="svg-icon svg-icon-2 me-2"><i class="far fa-edit fs-2"></span></i><span class="text-uppercase fs-3">{{ __('service::modal.edit-title') }}</span></p>
        </div>
        <!--end::Modal title-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                        <input type="text" class="form-control custom-form-control" placeholder="" name="name_en" value="{{$service->name_en}}">
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control custom-form-control" placeholder="" name="name_ar"  value="{{$service->name_ar}}">
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
